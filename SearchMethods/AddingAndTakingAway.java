...
public class AddingAndTakingAway extends BFSearch
{
	...
	public void weightsOfEdgesAfterInitialization(Car car, Road road, String reason)
	{
		if(reason.equals("CarRemoved"))
		{
			...
			{
				if(car.getNextRoad( ).getWeightOfRoad( )[0] > car.getTimeTakenToTravelDownRoad( ))
				{
			...
			if(car.getCurrentRoad( ).getWeightOfRoad( )[car.getCurrentRoad( ).getGoingTo( ).getIndex(car.getCurrentRoad( ), car.getNextRoad( ))] > 0)
			{
